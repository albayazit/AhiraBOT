...
async def markup_tracker(user_id):
	...
	markup_tracker.add(InlineKeyboardButton('Фаджр', callback_data='tracker_fajr')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT fajr FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT fajr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton('-', callback_data= 'minus_fajr')).insert(InlineKeyboardButton('+', callback_data='plus_fajr'))
	markup_tracker.add(InlineKeyboardButton('Зухр', callback_data='tracker_zuhr')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT zuhr FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT zuhr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton('-', callback_data='minus_zuhr')).insert(InlineKeyboardButton('+', callback_data='plus_zuhr'))
	markup_tracker.add(InlineKeyboardButton('Аср', callback_data='tracker_asr')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT asr FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT asr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton('-', callback_data='minus_asr')).insert(InlineKeyboardButton('+', callback_data='plus_asr'))
	markup_tracker.add(InlineKeyboardButton('Магриб', callback_data='tracker_magrib')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT magrib FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT magrib_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton('-', callback_data='minus_magrib')).insert(InlineKeyboardButton('+', callback_data='plus_magrib'))
	markup_tracker.add(InlineKeyboardButton('Иша', callback_data='tracker_isha')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT isha FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT isha_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton('-', callback_data='minus_isha')).insert(InlineKeyboardButton('+', callback_data='plus_isha'))
	if sqlite_bd.cur.execute(f'SELECT vitr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0] == '0':
		pass
	else:
		markup_tracker.add(InlineKeyboardButton('Витр', callback_data='tracker_vitr')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT vitr FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT vitr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='10')).insert(InlineKeyboardButton('-', callback_data='minus_vitr')).insert(InlineKeyboardButton('+', callback_data='plus_vitr'))
