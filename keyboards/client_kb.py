...
markup_dua.add(InlineKeyboardButton('Адама (мир Ему)', callback_data='dua_1')).add(InlineKeyboardButton('Айюба (мир Ему)', callback_data='dua_2')).add(InlineKeyboardButton('Ибрахима (мир Ему)', callback_data='dua_3')).add(InlineKeyboardButton('Мусы (мир Ему)', callback_data='dua_4')).add(InlineKeyboardButton('Шуайба (мир Ему)', callback_data='dua_5')).add(InlineKeyboardButton('Йусуфа (мир Ему)', callback_data='dua_6')).add(InlineKeyboardButton('Йунуса (мир Ему)', callback_data='dua_7')).add(InlineKeyboardButton('Лута (мир Ему)', callback_data='dua_8'))