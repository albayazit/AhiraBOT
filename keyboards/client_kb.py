...
async def markup_tracker(user_id):
	...
	markup_tracker.add(InlineKeyboardButton('Фаджр', callback_data='tracker_salat')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT fajr FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_current')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT fajr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_need')).insert(InlineKeyboardButton('-', callback_data= 'minus_fajr')).insert(InlineKeyboardButton('+', callback_data='plus_fajr'))
	markup_tracker.add(InlineKeyboardButton('Зухр', callback_data='tracker_salat')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT zuhr FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_current')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT zuhr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_need')).insert(InlineKeyboardButton('-', callback_data='minus_zuhr')).insert(InlineKeyboardButton('+', callback_data='plus_zuhr'))
	markup_tracker.add(InlineKeyboardButton('Аср', callback_data='tracker_salat')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT asr FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_current')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT asr_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_need')).insert(InlineKeyboardButton('-', callback_data='minus_asr')).insert(InlineKeyboardButton('+', callback_data='plus_asr'))
	markup_tracker.add(InlineKeyboardButton('Магриб', callback_data='tracker_salat')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT magrib FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_current')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT magrib_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_need')).insert(InlineKeyboardButton('-', callback_data='minus_magrib')).insert(InlineKeyboardButton('+', callback_data='plus_magrib'))
	markup_tracker.add(InlineKeyboardButton('Иша', callback_data='tracker_salat')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT isha FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_current')).insert(InlineKeyboardButton(sqlite_bd.cur.execute(f'SELECT isha_need FROM tracker WHERE user_id == {user_id}').fetchone()[0], callback_data='tracker_need')).insert(InlineKeyboardButton('-', callback_data='minus_isha')).insert(InlineKeyboardButton('+', callback_data='plus_isha'))
